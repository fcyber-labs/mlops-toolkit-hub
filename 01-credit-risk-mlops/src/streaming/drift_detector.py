...
def detect_drift_for_both_models():
    ...
    if ref_path_german.exists():
        ...
        if len(common_cols) > 0:
            ...
            report_german = detector_german.detect_all_drift(current_data_german[common_cols], model_name="german_credit")
    ...
    if ref_path_lending.exists():
        ...
        if len(common_cols) > 0:
            ...
            report_lending = detector_lending.detect_all_drift(current_data_lending[common_cols], model_name="lendingclub")
