...
def plot_dashboard(
    ...
    ax1.annotate("", xy=(ks_fpr, ks_tpr), xytext=(ks_fpr, ks_fpr),
    ...
    ax2.axvline(m["recall"],    color="red",  ls=":", alpha=0.7,
    ...
    ax6.hist(y_proba[y_true == 1], bins=60, alpha=0.6, color="#DC2626",
    ...
    ax9.barh(fi["feature"][::-1], fi["importance"][::-1],
             color="#0284C7", edgecolor="white")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", type=float, default=None,
                        help="Override the saved threshold")
